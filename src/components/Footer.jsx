...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-t border-t border-black/50 from-[#d25483]/50 to-[#d25483]/5">
        ...
        <div className="grid gap-12 md:grid-cols-3">
                ...
                <div className="space-x-2">
                  {contact.phones?.map((phone, i) => (
                    <React.Fragment key={phone}>
                      ...
                      <a href={`tel:${phone}`} className="transition-colors hover:text-[#d25483] hover:underline">
                        {phone}
                      </a>
                    </React.Fragment>
                  ))}
            ...
            {contact.social?.instagram && (
              <div className="pt-4">
                ...
                >
                  ...
                  <span className="group-hover:underline">{contact.social.instagram.replace('https://instagram.com/', '@')}</span>
                </a>
              </div>
            )}
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="overflow-hidden rounded-lg shadow-lg">
              <iframe
                title="Google Maps"
                src={contact.social?.googleMaps?.replace('https://www.google.com/maps/place/', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3009.234234234!2d28.853100315392!3d41.0392831792976!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14bea9194ba16bad%3A0xf1b1f78a1bda6a3d!2sGüneşli%20Mah.%20%C3%9Csk%C3%BCp%20Cad%2C%201253.%20Sk%20No%3A2%2C%2034212%20Ba%C4%9Fc%C4%B1lar%2F%C4%B0stanbul!5e0!3m2!1str!2str!4v1680000000000!5m2!1str!2str') || ''}
                width="100%"
                height="200"
                style={{ border: 0 }}
                allowFullScreen=""
